...
const NotFoundPage = () => {
    ...
    return (
        <div>
            ...
            <button onClick={handleNavigate} className='text-center center flex items-center justify-center gap-2 cursor-pointer mt-3 px-3 py-2 rounded-lg bg-gray-400 mx-auto'><FaArrowLeft></FaArrowLeft> Go Back to Home</button>
        </div>
    );
};
